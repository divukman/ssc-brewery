...
@Slf4j
public abstract class SfgRestAbstractFilter extends AbstractAuthenticationProcessingFilter {


    public SfgRestAbstractFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
